...
public class CopySubCommand : SubCommandLinkBase
{
    private readonly IArgument<CopyCommandBuilder> _arguments;

    public CopySubCommand(IArgument<CopyCommandBuilder> arguments)
    {
    ...
    public override SubCommandParseResultType Apply(IEnumerator<string> iterator)
    {
        ...
        var commandBuilder = new CopyCommandBuilder();
